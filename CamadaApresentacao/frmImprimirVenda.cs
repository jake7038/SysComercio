...
namespace CamadaApresentacao
{
    ...
    public partial class frmImprimirVenda : Form
    {
        ...
        public void setimprimirvenda(string nome, string data, string comprovante, string total)
        {
        ...
        private void ImprimirPDF()
        {
            ...
            Document.Create(container =>
            {
                container.Page(page =>
                {
                    ...
                    page.Header()
                        .Text("Faeterj - Relatório da Venda")
                        .FontSize(40);
                    page.Content()
                    .Column(X => {
                        X.Item()
                ...
                .GeneratePdf(filePath: "C:\\Users\\rafae\\OneDrive\\Área de Trabalho/arquivoVenda.pdf");
