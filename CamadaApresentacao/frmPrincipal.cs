...
namespace CamadaApresentacao
{
    public partial class frmPrincipal : Form
    {
        ...
        private void categoriasToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            //associa ao formulario principal
            frm.MdiParent = this; //o menu é o pai

            frm.Show();
        }

        private void apresentacãoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            //abre a janela
        ...
        //quebra galho, arrumar melhor isso depois
        ...
        private void produtosToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            ...
            frmProduto _Instancia = frmProduto.GetInstancia();
            _Instancia.MdiParent = this;
            _Instancia.Show();
